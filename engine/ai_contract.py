...
AI_CANONICALIZATION_V1 = AI_CANONICALIZATION
AI_CANONICALIZATION_V2 = "aelitium_jcs_profile_v2"
AI_CANONICALIZATION_IDENTIFIERS = frozenset(
    {AI_CANONICALIZATION_V1, AI_CANONICALIZATION_V2}
)
